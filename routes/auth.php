...
Route::middleware(['guest', \App\Http\Middleware\LanguageMiddleware::class])->group(function () {
...
Route::middleware(['auth', \App\Http\Middleware\LanguageMiddleware::class])->group(function () {
