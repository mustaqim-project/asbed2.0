<div class="card card-style mb-0">
    <a href="#" class="footer-title pt-4">Sadar BED</a>
    <p class="text-center font-12 mt-n1 mb-3 opacity-70">
        Menemukan <span class="color-highlight">Keseimbangan</span> dalam hidup Anda
    </p>
    <p class="boxed-text-l">
        Didedikasikan untuk membantu Anda memahami dan mengelola Binge Eating Disorder dengan dukungan penuh.
    </p>
    ...
    <p class="footer-copyright pb-3 mb-1">Copyright &copy; Sadar BED <span id="copyright-year">2024</span>. All Rights Reserved.</p>
</div>
<div class="footer-card card shape-rounded" data-card-height="230">
    <div class="card-overlay bg-highlight opacity-95"></div>
    <div class="card-bg preload-img" data-src="images/pictures/bed-awareness.jpg"></div>
</div>
